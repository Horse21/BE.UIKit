### 1. Сделайте ["форк"](http://help.github.com/fork-a-repo/) репозитория Horse21, а затем клонируйте его в свою локальную среду разработки
<pre>
git clone git@github.com:имя-вашего-пользователя/BE.UIKit.git
</pre>

### 2. Добавьте основной репозиторий Horse21 как удаленный (remote) с названием "upstream"
...
### 3. Получите последние изменения кода из основного репозитория Horse21
<pre>
git fetch upstream
</pre>
...
### 4. Создайте новую ветку, основанную на текущей develop ветке Horse21
<pre>
...
### 9. Пришлите [pull request](http://help.github.com/send-pull-requests/) в основной репозиторий Horse21
